...
#2024-4-7 : I.G Kwon : named shadow update 참조 사이트
#https://aws.github.io/aws-iot-device-sdk-python-v2/awsiot/iotshadow.html#awsiot.iotshadow.IotShadowClient.publish_update_named_shadow
# publish_update_named_shadow(request, qos), 
# UpdateNamedShadowRequest(*args, **kwargs) 적용해서 named shadow를 update 한다. 
