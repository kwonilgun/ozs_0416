...
if __name__ == '__main__':
    ...
    mqtt_connection = mqtt_connection_builder.mtls_from_path(
        endpoint= "a9gxi0conitbh-ats.iot.ap-northeast-2.amazonaws.com",
        port="8883",
        cert_filepath="kwon/kwon/Raspberry/Iot-2024_3_20/aws-iot-device-sdk-python-v2/OZS-20240404/cert/ozs_0406.cert.pem",
        pri_key_filepath="kwon/kwon/Raspberry/Iot-2024_3_20/aws-iot-device-sdk-python-v2/OZS-20240404/cert/ozs_0406.private.key",
        ca_filepath="kwon/kwon/Raspberry/Iot-2024_3_20/aws-iot-device-sdk-python-v2/OZS-20240404/cert/root-CA.crt",
        client_id="ozs-device-2",
        clean_session=False,
        keep_alive_secs=30,
